            ...
            {(data?.products ?? []).map((product, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">{product.quantity} {product.unit}</p>
                  <p className={`${priceDisplayClassName} mt-1`}>{formatPriceDisplay(product, rates, product.unit)}</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            {(data?.products ?? []).map((product, i) => (
              ...
              >
                ...
                <p className={priceDisplayClassName}>{formatPriceDisplay(product, rates, product.unit)}</p>
