...
export default function AdminOrderDetail() {
  ...
  return (
    <AppLayout>
      <Receipt order={order} variant="invoice" printDoc="invoice" />
      <Receipt order={order} variant="receipt" printDoc="receipt" />
      <div className="p-4 md:p-6 max-w-lg mx-auto no-print">
        <div className="flex items-start justify-between gap-3 mb-5">
          ...
          <div className="flex gap-2 shrink-0 flex-wrap justify-end">
            <Button size="sm" variant="outline" onClick={() => printDocument("invoice")} data-testid="button-print-invoice">
