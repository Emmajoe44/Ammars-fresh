...
import { Leaf, User, Phone, Lock, MapPin, AtSign, Eye, EyeOff } from "lucide-react";
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="bg-card border border-border rounded-2xl shadow-lg p-8">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-2xl font-extrabold text-foreground">Join {brand.name}</h1>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input type={showPassword ? "text" : "password"} placeholder="Min 6 characters" className="pl-10 pr-10" data-testid="input-password" {...field} />
                      <button
                        type="button"
