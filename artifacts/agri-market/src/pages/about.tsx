      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10">
          ...
          <div className="relative max-w-4xl mx-auto px-6 py-20 sm:py-28 text-center">
            ...
            >
              {t(
                "AgriMarket is South Sudan's digital marketplace for fresh produce — built to give farmers a fair price, retailers a steady supply, and the country a stronger food system.",
                "أجريماركت هو السوق الرقمي للمنتجات الطازجة في جنوب السودان — لمنح المزارعين سعرًا عادلاً، وتجار التجزئة إمدادًا مستقرًا، ونظامًا غذائيًا أقوى للبلاد.",
              )}
            </motion.p>
          </div>
        </section>
