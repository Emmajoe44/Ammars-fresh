  ...
  return (
    <AppLayout>
      <div className="p-4 md:p-6 pb-20 md:pb-8 max-w-lg mx-auto">
        ...
        <div className="mb-6">
          <ProfilePhotoUpload avatarUrl={me?.avatarUrl} fallbackIcon={<Tractor className="w-8 h-8 text-primary" />} />
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-5">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={updateMe.isPending} data-testid="button-save">
